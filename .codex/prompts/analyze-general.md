...
Perform deep analysis of any Trigger.dev task execution logs with comprehensive code correlation.

User request: $ARGUMENTS

Convert user request to RUN_ID usually for run_<uuid> number, and user question request QUERY, rest of the user text


**Execution:**
Analyze the specified Trigger.dev task logs using the comprehensive methodology below.
...
6. address the user specific query/request QUERY
