    ...
    return (
        <Button
            ...
            className={cn(
                ...
                stretch ? 'flex-1 min-h-10 sm:min-h-12' : 'flex-none min-h-10 sm:min-h-12',
                toneClasses[tone],
    ...
    ({ buttons, side = 'left', className, fitContent = false, maxWidthPercent = 50 }, ref) => {
        return (
            <div
                ref={ref}
                className={cn(
                    'pointer-events-auto absolute top-0 bottom-0 z-50 flex flex-col gap-0 border-2 border-border bg-gray-900 px-0 py-3 sm:py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] overflow-y-auto',
